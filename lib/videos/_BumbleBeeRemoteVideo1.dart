...
class BumbleBeeRemoteVideo1 extends StatefulWidget {
  @override
  _BumbleBeeRemoteVideoState createState() => _BumbleBeeRemoteVideoState();
}

class _BumbleBeeRemoteVideoState extends State<BumbleBeeRemoteVideo1> {
  ...
  void initState() {
    super.initState();
    init();
    //_counterRef = FirebaseDatabase.instance.ref('Review');
    _controller = VideoPlayerController.asset(
     // 'https://flutter.github.io/assets-for-api-docs/assets/videos/bee.mp4',
      "assets/videos/Acceleration_Motion.mp4",
     // closedCaptionFile: _loadCaptions(),
      videoPlayerOptions: VideoPlayerOptions(mixWithOthers: true),
    );

    // _controller = VideoPlayerController.network(
    //     'https://www.youtube.com/watch?v=vxFYfumAAlY',videoPlayerOptions: VideoPlayerOptions(mixWithOthers: true))
  ...
  void SaveReview(){
    ...
    _counterRef.child('Acceleration_Motion/Reviews/'
    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
         ...
         // const Text('What is Acceleration ?'),
